...
public class ResourceExceptionHandler {
    ...
    // tratando da excecção lançada quando recebe parametros incorretos atraves da
    // API
    ...
    public ResponseEntity<StandardError> methodArgumentNotValidException(MethodArgumentNotValidException e) {
        ...
        // a exceção lançada por MethodArgument... mostra uma lista de erros para cada
        // campo recebido inválido.
